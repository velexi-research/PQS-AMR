 ...
 * partial differnetial equations in three space dimensions
 */
...
#ifndef INCLUDED_PQS_math_boundary_conditions_3d_h
#define INCLUDED_PQS_math_boundary_conditions_3d_h
